            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('historiquebonlivraison') }}" class="text-muted">{{$titre}}</a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('historiquebonlivraison')}}" method="post"
                            ...
                            <div class="col-lg-12">
                                ...
                                <table class="table table-bordered "
                                    ...
                                    foreach ($recherches as $recherche):
                                        $montanttotal += $recherche->prix_ttc_bl;
                                        $i++;
                                        ?>

                                        <tr>
                                            <td>{{ $i}}</td>
                                            <td>{{ $recherche->num_bl}}</td>
                                            <td>{{ $recherche->nom_cli}} {{ $recherche->prenom_cli}}</td>
                                            <td><?php echo number_format($recherche->prix_ttc_bl); ?> </td>
                                            <td><?php if ($recherche->flag_bl == true) { ?>
                                                    <span class="label label-lg font-weight-bold label-warning label-inline"> Validé</span>
                                                <?php }else{ ?>
